...
>>>>>>> 0de4ffc7f341054774f71b4449cce891364c53e3
...
>>>>>>> 0de4ffc7f341054774f71b4449cce891364c53e3
	...
	contém os valores e incertezas finais dos períodos medidos utilizando fotodiodo ($T^{(1)}$) e tracker ($T^{(2)}$), as estimativas obtidas
	da aceleração da gravidade local ($g^{(1)}$ e $g^{(2)}$, respectivamente), e o valor de referência da aceleração local da gravidade $g_{0}$
