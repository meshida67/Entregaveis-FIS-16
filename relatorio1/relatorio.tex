...
\begin{multicols}{2}
	...
	Além disso, a Figura \ref{fig:histograma} contém o histograma dos valores medidos por meio da fotoporta comparado a uma distribuição gaussiana com a mesma média e desvio padrão que os conjunto de dados obtido.
    ...
    Por fim, a Tabela \ref{tab:resultadoss} contém os valores obtidos para o período e aceleração da gravidade por meio dos métodos manuais baseados no uso de cronômetros.
    ...
    \begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{desvios_histograma.png}
	\caption{Desvios calculados para os dados do fotodiodo}
	\label{fig:desvios}
	\end{figure}
