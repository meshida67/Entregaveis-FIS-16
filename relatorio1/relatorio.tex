...
\begin{document}
	...
	\begin{center}
		...
		{\large\bfseries
			Determinação da gravidade por meio do pêndulo simples\\[2.0\baselineskip]
		}
	...
	\begin{multicols}{2}
		...
		Portanto, comparando as Equações \ref{eq:energia} e \ref{eq:energiaMHS}, pode-se obter a frequência angular $\omega = 2\pi/T$ do Movimento Harmônico que o pêndulo executa em pequenas amplitudes, assim como está na Equação \ref{eq:omega}.
