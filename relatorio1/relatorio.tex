...
pêndulo simples com amplitude de oscilação pequena, tendo sido utlizados cronômetros de mão e de bancada, além de um fotodiodo e
um software tracker em alta taxa de amostragem,
...
\begin{multicols}{2}
	...
	\begin{table}[H]
		...
		\begin{tabular}{l l l}
			...
			$g^{(3)} \mathrm{(m/s^{2})}$ & $9,743945$ & $0,104385$ \\
			$g^{(4)} \mathrm{(m/s^2)} $  &            &            \\
